export default function About() {
    const tools = [
        ...
        { name: 'figma', icon: './assets/github-logo.png', },
        { name: 'git', icon: './assets/git.png', },
        { name: 'mongodb', icon: './assets/docker-logo.png', },
        { name: 'firebase', icon: './assets/supabase-logo.png', },
    ];
    ...
    const data = [
        {
            ...
            description: 'Python, JavaScript React Js,TypeScript, NodeJs, Java',
        },
        {
            name: 'Education',
            icon1: './assets/edu-icon.png',
            icon2: './assets/edu-icon-dark.png',
            description: 'B.Tech in Software Engineering',
        },
        {
            name: 'Projects',
        ...
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">I am an experienced Software Developer with 2 years of professional expertise in the field. Throughout my career, I have had the privilege of collaborating with prestigious organizations, contributing to their success and growth.</p>
