export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            ...
            <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">Software developer based in London.</h1>
            <p className="max-w-2xl mx-auto font-Ovo">I am a software developer from Nairobi, Kenya with 2 years of experience in multiple companies like Microsoft, Google and Kujuanpointllc.</p>
